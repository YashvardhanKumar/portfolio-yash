          ...
          <div className="flex flex-col gap-2  text-gray-400 sm:p-5 p-3">
            ...
            >
              ...
              >
                ...
                >
                  {links.map((e) => (
                    <div className="bg-white/5 backdrop-blur-sm border border-white/10 px-2 py-1 rounded-md sm:text-sm text-xs flex items-center gap-2">
                ...
                <a
                  href={lor}
                  className="bg-white/5 backdrop-blur-sm border border-white/10 px-2 py-1 rounded-md sm:text-sm text-xs flex items-center gap-2 w-fit"
                >
